...
nifti_file = nib.Nifti1Image(downsampled_data[index], np.eye(4))
nib.save(nifti_file, os.path.join("output path to save the downsampled image", '__filname__.nii.gz')) 
